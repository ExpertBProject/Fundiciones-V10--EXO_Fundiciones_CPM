...
namespace Cliente
{
    public class csNormas
    {
        ...
        public void GenerarFicheroNorma58(string Ruta, SAPbouiCOM.Form Formulario)
        {
            ...
            string cNumDeposito = Utilidades.DameValorEditTextFUNDI("3", Formulario);

            string cEntidad = Utilidades.DameValorEditTextFUNDI("20", Formulario);
            string cOficina = Utilidades.DameValorEditTextFUNDI("12", Formulario);
            string cCuenta = Utilidades.DameValorEditTextFUNDI("14", Formulario);
            ...
            cNifEmpresa = ( Utilidades.DameValorFUNDI ("OADM", "TaxIdNum", "")).Substring(2).ToString();
            cPobEmpresa = Utilidades.DameValorFUNDI("ADM1", "City", "");
            cProvEmpresa = Utilidades.DameValorFUNDI("ADM1", "ZipCode", "");
            /*****************digito de control del banco**********/
            cDigito = Utilidades.DameValorFUNDI("DSC1", "ControlKey", "BankCode = " + cEntidad);
            cSufijo = "000";
            ...
            /*Recorro los efectos*/
            string sql = "SELECT T2.[Cardname],T2.[CardCode],T2.[BoeNum], T2.[DueDate], T2.[BoeSum], " +
            ...
            Matriz.oGlobal.conexionSAP.SBOApp.MessageBox("Fichero Generado", 1, "", "", "");
        }
        ...
        public string CabeceraPresentador58(string cNifEmpresa, string cSufijo, string cEntidad, string cOficina)
        {
            ...
            cDatos = cDatos + Matriz.oGlobal.conexionSAP.SBOApp.Company.Name.PadRight(40);
            //libre
            cRelleno = "";
                                             ...
                                             string cPobEmpresa, string cProvEmpresa)
        {
            ...
            oRecordSet = (SAPbobsCOM.Recordset)Matriz.oGlobal.conexionSAP.compañia.GetBusinessObject(BoObjectTypes.BoRecordset);
        ...
        public void GeneroFicheroNorma19(string Ruta, SAPbouiCOM.Form Formulario)
        {
            ...
            string cOficina = Utilidades.DameValorEditTextFUNDI("12", Formulario);
            string cCuenta = Utilidades.DameValorEditTextFUNDI("14", Formulario);
            string cFechaRemesa = Utilidades.DameValorEditTextFUNDI("9", Formulario);
            ...
            /*****************digito de control del banco**********/
            cDigito = Utilidades.DameValorFUNDI("DSC1", "ControlKey", "BankCode = " + cEntidad);
            cSufijo = Utilidades.DameValorFUNDI("DSC1", "UsrNumber2", "BankCode = " + cEntidad).PadLeft(3);
            //Miro el efecto actual
