...
namespace Cliente
{
    public class csNormas
    {
        ...
        public void GenerarFicheroNorma58(string Ruta, SAPbouiCOM.Form Formulario)
        {
            ...
            Matriz.oGlobal.SBOApp.MessageBox("Fichero Generado", 1, "", "", "");
        }
        ...
        public string CabeceraPresentador58(string cNifEmpresa, string cSufijo, string cEntidad, string cOficina)
        {
            ...
            cDatos = cDatos + Matriz.oGlobal.SBOApp.Company.Name.PadRight(40);
            //libre
            cRelleno = "";
                                             ...
                                             string cPobEmpresa, string cProvEmpresa)
        {
            ...
            oRecordSet = (SAPbobsCOM.Recordset)Matriz.oGlobal.compañia.GetBusinessObject(BoObjectTypes.BoRecordset);
